...
class _TutorialScreenState extends ConsumerState<TutorialScreen> {
  ...
  final List<Map<String, dynamic>> _pages = [
    {
      ...
      'description': 'Agrega todos tus ingresos mensuales para tener un control total de tu dinero.',
      'color': Colors.green,
    },
    {
      'icon': Icons.remove_circle,
      'title': 'Controla tus gastos',
      'description': 'Registra cada gasto diario y clasifícalo por categorías para entender dónde va tu dinero.',
      'color': Colors.red,
    },
    {
      'icon': FontAwesomeIcons.piggyBank,
      'title': 'Ahorra con metas',
      'description': 'Define metas de ahorro y sigue tu progreso mes a mes. ¡Alcanza tus sueños financieros!',
      'color': Colors.orange,
    },
    {
      'icon': FontAwesomeIcons.chartLine,
      'title': 'Visualiza tu portafolio',
      'description': 'Revisa gráficos e inversiones en tu portafolio personalizado. Todo en un solo lugar.',
      'color': Colors.purple,
    },
    {
      'icon': FontAwesomeIcons.calendarCheck,
      'title': 'Programa tus pagos',
      'description': 'No olvides fechas importantes. Programa tus pagos y recibe recordatorios a tiempo.',
      'color': Colors.blue,
    },
    {
      'icon': Icons.account_balance_wallet,
      'title': 'Resumen financiero',
      'description': 'Verás aquí tu saldo disponible, ingresos y gastos totales del mes. Es tu dashboard principal.',
      'color': Colors.cyan,
    },
    {
  ...
  void _skipTutorial() async {
    try {
      debugPrint('>>> [_skipTutorial] Intentando marcar tutorial como visto y navegar a home...');
      final notifier = ref.read(tutorialNotifierProvider);
      await notifier.markAsSeen(); // ✅ Esto imprime el valor guardado (ver tutorial_provider.dart)
      if (!mounted) return;
  ...
  void _finishTutorial() async {
    try {
      debugPrint('>>> [_finishTutorial] Intentando marcar tutorial como visto y navegar a home...');
      final notifier = ref.read(tutorialNotifierProvider);
      await notifier.markAsSeen(); // ✅ Esto imprime el valor guardado (ver tutorial_provider.dart)
      if (!mounted) return;
      Navigator.pushReplacementNamed(context, AppRoutes.home);
